"""
person4_quantization_v2.py — Post-training quantization implemented from scratch.
...
Usage:
    python person4_quantization_v2.py --data_dir ./fruits-360-100x100 --model_path models/v2_best

Quick test:
    python person4_quantization_v2.py --data_dir ./fruits-360-100x100 --model_path models/v2_best --max_per_class 50
"""
...
def main(args):
    ...
    model.load_bn_params(args.model_path)
    model.eval()
